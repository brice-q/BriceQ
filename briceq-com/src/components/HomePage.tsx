...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center px-6">
      <h1 className="text-6xl font-bold mb-50 text-[#0ea5e9] animate-pulse drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">BriceQ</h1>

      {/* Main content section with image and text */}
      <div className="flex flex-col lg:flex-row items-center justify-center max-w-6xl mx-auto gap-10 mb-40">
        {/* Left side - Image */}
